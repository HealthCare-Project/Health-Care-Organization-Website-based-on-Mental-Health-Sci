...
<!-- ***** Breadcrumb Area END ***** -->
    ...
    <div >
		...
		@foreach($posts as $post)
            <a href="{{url('posts',$post['id'])}}" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business">
                <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
                    <img style="height: 194px;" class="card-img-top" src="{{url($post['feature_image'])}}" alt="...">
                    <div class="card-body">
                        <h5 class="card-title light-300 text-dark">{{$post['title']}}</h5>
                        <p class="card-text light-300 text-dark">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                            sed do eiusmod tempor incididunt ut labore et dolor.
                        </p>
                        <span class="text-decoration-none text-primary light-300">
						{{$post['publish_date']}} <i class='bx bxs-hand-right ms-1'></i>
                          </span>
