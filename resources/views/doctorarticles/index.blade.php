			...
			<div class="col-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Doctor Articles</li>
					</ol>
				</nav>
			</div>
		</div>
...
<!-- ***** Breadcrumb Area END ***** -->
    ...
    <div >
		...
		@foreach($doctorarticles as $doctorarticle)
            <a href="{{url('doctorarticles',$doctorarticle['id'])}}" class="col-sm-6 col-lg-4 text-decoration-none project marketing social business">
                <div class="service-work overflow-hidden card mb-5 mx-5 m-sm-0">
                    <img style="height: 194px;" class="card-img-top" src="{{url($doctorarticle['feature_image'])}}" alt="...">
                    <div class="card-body">
                        <h5 class="card-title light-300 text-dark">{{$doctorarticle['title']}}</h5>
                        <p style="-webkit-line-clamp: 2;text-overflow: ellipsis;
overflow: hidden;
white-space: nowrap;" class="card-text light-300 text-dark">
                            {{ $doctorarticle['content'] }}
                        </p>
                        <span class="text-decoration-none text-primary light-300">
						{{$doctorarticle['publish_date']}} <i class='bx bxs-hand-right ms-1'></i>
                          </span>
