	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-8">
				...
				<a href="{{url('relativesarticles',$relativesarticle['id'])}}">
					<!-- Single Blog Item -->
