                ...
                <div align="center">
                    <table cellspacing="1" cellpadding="0" border="0" bgcolor="#FFFFFF">
                        <tbody>
                            <tr>
                                <td>
                                    <table width="763" border="0" cellpadding="3" cellspacing="3" bgcolor="#FFFFFF"
                                        dir="rtl">
                                        <tbody>
                                            <tr>
                                                <td width="348">
                                                    <font size="4"><b>Sex :</b> <input checked="" name="sex" type="radio"
                                                            value="0"></font>
                                                    <font color="#0000FF"><b>
                                                            <font size="4">Male</font>
                                                        </b></font>
                                                    <font size="4"> <input name="sex" type="radio" value="1"></font><b>
                                                        <font color="#FF00FF" size="4">Female</font>
                                                    </b>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    ...
                                                    <font size="4"> <select name="wu" size="1">
                                                            <option value="0">
                                                                Pound</option>
                                            ...
                                            <tr>
                                                <td>
                                                    <font size="4" color="#000080"></font>
                                                    <font size="4"> </font>
                                                    <input type="number" class="form-control" name="ht" required=""
                                                        placeholder="Enter your height">
                                                    <font size="4"> <select name="hu" size="1">
                                                            <option value="0">
                                                                "</option>
                                            ...
                                            <tr>
                                                <td>
                                                    <input name="button" onclick="bmiCalc(this.form)" type="button"
                                                        value="Calculate"
                                                        style="color:#FFFFFF; font-size:12pt; background-color:#FF9933">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                            ...
                                            <tr>
                                                <td>
                                                    <font color="#663300">Surface area of The body:</font>
                                                    <font size="4"> <input maxlength="5" name="bsa" size="5"></font>
                                                    m<sup>2</sup>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <font color="#008000"><b>Your Ideal Weight is :</b></font>
                                                    <font size="3" color="#008000"><input maxlength="5" name="idealKg"
                                                            size="3" style="color: #008000; "></font>
                                                    <font color="#008000">
                                                        <b>Kg</b> =
                                                    </font>
                                            ...
                                            <tr>
                                                <td>
                                                    <font color="#663300">Weight Without Grease :</font>
                                                    <font size="3"><input maxlength="5" name="leanKg" size="3"></font>
                                                    Kg <b>= </b>
                                                    <font size="4"> <input maxlength="5" name="leanLbs" size="3"> </font>
                                                    Pound
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <font color="#663300">Your ratio of body weight to Surface :</font>
                                                    <font size="4"> <input maxlength="5" name="bmi" size="5"></font>
                                                    Kg/m<sup>2</sup>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <input maxlength="12" name="interp"
                                                        style="color: #FF0000; font-size:10pt; font-family:Tahoma"
                                                        size="28">
                                                </td>
                                            </tr>
                                        </tbody>
