...
<body>
    <form class="box1" action="loginprocess.php" method="post">
        <p class="message"> Hello! <br> <br>
            Someone recently requested a password change for your HealthCare account. if this was you, you can set a new
            password here
        </p>
        <a id="reset-link" href="http://homestead.test/patient/reset-password/{{ $email_data }}">Reset</a>

        <p class="message"></p> if you don't want to change your password or didn't request this, just ignore and delete
        this message. <br> <br>
