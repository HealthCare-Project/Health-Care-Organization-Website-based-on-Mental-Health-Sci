        ...
        <div class="col-12 col-lg-8">
          ...
          <div class="single-blog-item style-2 d-flex flex-wrap align-items-center mb-50">
            ...
            <div class="blog-content">
              <a href="./pressure.html" class="post-title">All you Have To Know About Pressure disease and treatment</a>
              <p>Many people suffer from blood pressure, a disease that increases blood pressure, which rushes from the blood vessels of the body parts ...</p>
              <div class="post-meta">
          ...
          <div class="single-blog-item style-2 d-flex flex-wrap align-items-center mb-50">
            ...
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="./diabetes.html" class="post-title">What is Diabetes?</a>
              <p>Diabetes is a disease that occurs when your blood glucose, also called blood sugar, is too high. Blood glucose is your main source of energy and comes from the food you eat. Insulin, a hormone made by the pancreas ...</p>
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i> 28 Sep 2018</a>
                <a href="#"><i class="icon_chat_alt"></i> 3 Comments</a>
              </div>
          ...
          <div class="single-blog-item style-2 d-flex flex-wrap align-items-center mb-50">
            ...
            <!-- Blog Content -->
            <div class="blog-content">
              <a href="./diabetes.html">" class="post-title">How long does numbness last after the dentist?</a>
              <p>Donec tempor, lorem et euismod eleifend, est lectus laoreet ante, sed accusan justo diam nec tincidunt interdum ante consectetur dapibus molestie ...</p>
              <div class="post-meta">
                <a href="#"><i class="icon_clock_alt"></i> 28 Sep 2018</a>
                <a href="#"><i class="icon_chat_alt"></i> 3 Comments</a>
