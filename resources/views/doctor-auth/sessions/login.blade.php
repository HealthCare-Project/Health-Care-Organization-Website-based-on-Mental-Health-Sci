...
<head>
    <meta charset="utf-8">
    <title> Login </title>
    <link rel="stylesheet" type="text/css" href="{{ asset('css/doctor_style/doctor_login.css') }}">
</head>

<body>
    <form method="POST" class="boxlog" action="{{ route('doctor.login') }}">
        @csrf
        <h2> sign in </h2>
        ...
        <p class="message"> Don't have an account? <a href="register"> Sign up </a></p>
    </form>
</body>
