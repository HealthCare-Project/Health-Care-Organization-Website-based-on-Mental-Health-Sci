...
<html lang="en">
<head>
  <title>Doctor Articles Post</title>
  <meta charset="utf-8">
...
<body style=' background-image: url("DoctorArticle.jpg");'>
<div class="breadcumb-area bg-img bg-gradient-overlay" style="background-image: url(DoctorArticle.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <h2 class="title">Doctor Articles Encyclopedia </h2>
                </div>
            </div>
        </div>
    </div>
