...
<html lang="en">
<head>
  <title>Relatives Articles Post</title>
  <meta charset="utf-8">
...
<body style=' background-image: url("relatives.jpg");'>
<div class="breadcumb-area bg-img bg-gradient-overlay" style="background-image: url(img/bg-img/relatives.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <h2 class="title">Relatives Articles Encyclopedia </h2>
                </div>
            </div>
        </div>
    </div>
...
<div  class="container">
  ...
  <form action = "/create4" method = "post" class="box3"  action="/action_page.php">
